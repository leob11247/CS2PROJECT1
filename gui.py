...
class Gui:
    def __init__(self, window):
        ...
        self.frame_three = Frame(self.window, bd='100')
    ...
    def vote(self):
        vote = self.radio_answer.get()
        if vote == 1:
            self.label_fill.config(text="You voted for Jane")
            print('Jane')
        else:
            self.label_fill.config(text="You voted for John")
            print('John')
